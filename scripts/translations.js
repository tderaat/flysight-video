...
var I18N = {
  en: {
    ...
    'convert.note': 'The conversion runs entirely on your computer, nothing is uploaded. A long clip can take several minutes.',
  ...
  de: {
    ...
    'convert.note': 'Die Umkodierung läuft vollständig auf Ihrem Computer, es wird nichts hochgeladen. Bei einem langen Clip kann das mehrere Minuten dauern.',
  ...
  nl: {
    ...
    'convert.note': 'Het omzetten gebeurt volledig op je eigen computer, er wordt niets geüpload. Bij een lange clip kan dit enkele minuten duren.',
  ...
  it: {
    ...
    'convert.note': 'La conversione avviene interamente sul tuo computer, non viene caricato nulla. Per una clip lunga può richiedere diversi minuti.',
